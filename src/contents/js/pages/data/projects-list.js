  ...
  return [
    {
      ...
      description:
        ...
        '다자인 시스템 개선 작업에서는 컴포넌트의 네이밍부터 표준화 작업을 진행했습니다. ' +
    ...
    },
    {
      ...
      type: 'Web/App Design',
      description:
        'iPortfolio에서 가장 기여를 많이한 프로젝트로 자사 대표 서비스의 UX/UI 디자인 업무를 진행했습니다. ' +
    ...
    },
    {
      ...
      imageURL: '/contents/img/projects/pick@2x.jpg',
      date: '2020.10 ~ 2020.12',
      role: 'Product UI/UX Design',
      type: 'App Design',
      description:
        '‘PICK’ 앱은 투표 형식의 설문 앱입니다.<br/>근무했던 회사에서는 입사한 지 얼마 안 된 막내가 음료 주문을 했습니다. 저 또한 과거에 그랬던 적이 있었고 매번 일일이 물어보고 답변이 올 때까지 기다리는 답답함과 다양한 주문에 힘들었던 적이 있습니다. 그 경험을 바탕으로 불편함을 개선하기 위한 앱 디자인을 진행했습니다.',
    },
    {
      name: 'ReBranding',
      path: 'rebranding',
      ...
      type: 'Logo Design',
      description:
        'EBS 리딩클럽 서비스가 국내 시장 외 해외 시장으로 서비스를 확장함에 따라 사용자가 쉽게 인지할 수 있고, ' +
    ...
    },
    {
      ...
      type: 'App Design',
      description:
        '멀리맘 앱은 연령별로 선정된 도서들을 분석해 성장기에 맞춘 자녀에게 도서를 추천하는 큐레이션 서비스 입니다. ' +
    ...
    },
    {
      name: 'MomTalk',
      path: 'momtalk',
      imageURL: '/contents/img/projects/momtalk@2x.png',
      date: '2015.04 ~ 2016.02',
      role: 'Product UI/UX Design',
      type: 'App Design',
      description:
